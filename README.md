...
- В нём есть **ДВА СЧЕТЧИКА**
- в нем есть **АТОМАРНЫЙ счётчик СИЛЬНЫХ ССЫЛОК** (shared_pointer-ов) ссылок, число ссылающихся на объект классов, которые используют указатель на объект
- второй **счётчик СЛАБЫХ ССЫЛОК** (weak_pointer-ов)
