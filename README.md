...
# Vector
- В основе - динамический массив (В КУЧЕ), занимает смежный или непрерывный участок в памяти, с О(1) доступ к элементам по индексу
...
- Создание и уничтожение потоков– дорогостоящие операции с точки зрения использования процессорного времени.РЕШЕНИЕ - создании пула предварительно выделенных потоков, которые могут обрабатывать рутинные задачи
